            ...
            columnDiv.innerHTML = `
                ...
                <div class="foreign-key-group hidden" style="margin-top: 1rem; padding: 1rem; background: rgba(255,255,255,0.05); border-radius: var(--radius); border: 1px solid rgba(255,255,255,0.08);">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input foreign-ref" placeholder="e.g., USER.email.name">
                        <div style="font-size: 0.75rem; color: var(--text-secondary); margin-top: 0.25rem;">Format: {referencedTableName}.{referencedColumnName}, multiple columns can be referenced by dividing with comma</div></div>
                    </div>
                </div>
            `;
